DROP DATABASE IF EXISTS SpotifyClone;
  ...
  INSERT INTO SpotifyClone.plan (type, cost)
  VALUES
    ('gratuito', 0.00),
    ('familiar', 7.99),
    ('universitário', 5.99),
  ...
  VALUES
    ...
    ('Nina Simone');
      ...
      INSERT INTO SpotifyClone.user (username, age, plan_id, join_date)
  VALUES
  ...
  VALUES
    ...
    ('I Put A Spell On You', 6, 2012);
              ...
              INSERT INTO SpotifyClone.song (title, artist_id, album_id, length)
  VALUES
